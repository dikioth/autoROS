...
from visualization_msgs.msg import (
    InteractiveMarkerControl, Marker, InteractiveMarker)
...
class DisplayInRviz:
    ...
    def processFeedback(self, feedback):
        ...
        rospy.loginfo(feedback.marker_name + " is pluginsnow at " +
    ...
    def Anchor0callback(self, data):
        ...
        try:
            ...
            rospy.loginfo("Anchor0 x: " + str(data.x) + " y: " +
                          str(data.y) + " z: " + str(data.z))
        except ValueError:
    ...
    def Anchor1callback(self, data):
        ...
        try:
            ...
            # TODO remove this after, Debugging purpose
            rospy.loginfo("Anchor1 x: " + str(data.x) + " y: " +
                          str(data.y) + " z: " + str(data.z))
    ...
    def Anchor2callback(self, data):
        ...
        try:
            ...
            # TODO remove this after, Debugging purpose
            rospy.loginfo("Anchor2 x: " + str(data.x) + " y: " +
                          str(data.y) + " z: " + str(data.z))
    ...
    def Anchor3callback(self, data):
        ...
        try:
            ...
            # TODO remove this after, Debugging purpose
            rospy.loginfo("Anchor3 x: " + str(data.x) + " y: " +
                          str(data.y) + " z: " + str(data.z))
    ...
    def TagCallback(self, data):
        ...
        try:
            ...
            # TODO remove this after, Debugging purpose
            rospy.loginfo("Tag x: " + str(data.x) + " y: " +
                          str(data.y) + " z: " + str(data.z))
