...
class PositionEstimator:
    ...
    def start_kalman_filter(self, loc_data):
        self.kf = init_kalman_filter(loc_data,
                                     ...
                                     dt=self.update_delay,
                                     dim_x=self.dim_x,
                                     dim_z=self.dim_z,
                                     dim_u=self.dim_u,
                                     use_acc=self.use_acc,
                                     speed_div_by_length=self.speed_div_by_length,
                                     meas_var_acc=self.meas_var_acc,
                                     meas_var_heading=self.meas_var_heading,
    ...
    def do_kalman_updates(self, measurements,  control_signal):
        ...
        self.estimated_state = kalman_updates(self.kf,
                                              loc_data,
                                              imu_data,
                                              variance_position=self.meas_var_pos,
